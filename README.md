...
* No LLMs have been used to write code in this project.
* All code in this project has been human crafted.
* An LLM (coderabbit) has been used as a code review tool. 
